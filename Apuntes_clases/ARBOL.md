...
def draw_foliage2():
    ...
    glPushMatrix()
    glColor3f(0.1, 0.5, 0.1)  # Verde para las hojas
    glTranslatef(0.0, 2.8, 0.0)  # Posicionar las hojas encima del tronco
    quadric = gluNewQuadric()
    gluSphere(quadric, 0.8, 32, 32)  # Radio de la esfera
    glPopMatrix()
...
def draw_foliage3():
    ...
    glPushMatrix()
    glColor3f(0.1, 0.5, 0.1)  # Verde para las hojas
    glTranslatef(0.0, 3.5, 0.0)  # Posicionar las hojas encima del tronco
    quadric = gluNewQuadric()
    gluSphere(quadric, 0.6, 32, 32)  # Radio de la esfera
    glPopMatrix()
...
def draw_ground():
    ...
    glBegin(GL_QUADS)
    glColor3f(0.3, 0.6, 0.3)  # Gris oscuro para el suelo
    glVertex3f(-10, 0, 10)
    glVertex3f(10, 0, 10)
    glVertex3f(10, 0, -10)
    glVertex3f(-10, 0, -10)
